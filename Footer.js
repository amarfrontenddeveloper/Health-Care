      ...
      <div className="container">
         <div className="row">
            <div className="col-lg-3 col-sm-6">
               ...
               <div className="map_icon"><img src="images/map-icon.png"/><span className="paddlin_left_0">Page when looking at its</span></div>
               <div className="map_icon"><img src="images/call-icon.png"/><span className="paddlin_left_0">+7586656566</span></div>
               <div className="map_icon"><img src="images/mail-icon.png"/><span className="paddlin_left_0">volim@gmail.com</span></div>
            </div>
            <div className="col-lg-3 col-sm-6">
